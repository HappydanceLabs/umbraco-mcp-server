/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 698bae74059f1673e48e00123c3174b9)
// Runtime types generated with workerd@1.20251001.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HappyDanceUmbracoMCPV2";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		MCP_AUTH_UUID: "d0deb1f3f8d4552a8b79439c697463aacae0ed0047d1d55d3a7fef5455c89409";
		UMBRACO_API_KEY: string;
		UMBRACO_BASE_URL: string;
		WAF_API_KEY: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").HappyDanceUmbracoMCPV2>;
	}
}
